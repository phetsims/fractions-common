 ...
 * please modify fractions-common/package.json to control dependencies.
 *
 * RequireJS configuration file for the fractions-common sim.
 * Paths are relative to the location of this file.
 */

require.config( {

  deps: [ 'fractions-common-tests' ],
