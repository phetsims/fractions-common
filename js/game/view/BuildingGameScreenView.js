...
class BuildingGameScreenView extends ScreenView {
  ...
  static createLevelIcon( level, hasMixedNumbers ) {
    ...
    assert && assert( ICON_DESIGN_BOUNDS.dilated( 1E-6 ).containsBounds( label.bounds ), 'Sanity check for level icon layout: - BuildingGame:label.bounds', ICON_DESIGN_BOUNDS.toString(), label.bounds.toString() );
    assert && assert( ICON_DESIGN_BOUNDS.dilated( 1E-6 ).containsBounds( iconContainer.bounds ), 'Sanity check for level icon layout - BuildingGame:iconContainer.bounds', ICON_DESIGN_BOUNDS.toString(), iconContainer.bounds.toString() );
